    ...
    >
      ...
      <div className="fixed inset-0 z-30 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <DialogPanel
            transition
            className="relative transform overflow-hidden rounded-xl bg-[#120F24] px-4 pt-5 pb-4 text-left shadow-2xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[enter]:ease-out data-[leave]:duration-200 data-[leave]:ease-in sm:my-8 sm:w-full sm:max-w-2xl sm:p-6 data-[closed]:sm:translate-y-0 data-[closed]:sm:scale-95"
          >
            ...
            <div className="min-w-0">
              <div className="flex items-start justify-between gap-4">
                ...
                <img
                  src="/images/EcstaticPanda.png"
                  alt="Ecstatic panda mascot"
                  className="hidden h-auto w-36 flex-shrink-0 object-contain sm:block md:w-32"
                />
              </div>
              ...
              <div className="mt-5 sm:mt-6">
                ...
                <div className="mt-4 space-y-3">
                  ...
                  <div className="flex flex-wrap gap-3">
                    <button
                      type="button"
                      className="rounded-lg border border-[rgba(240,194,255,0.25)] bg-[rgba(112,66,138,0.20)] px-4 py-2 text-sm font-medium text-[#F4EDEA] transition-colors hover:bg-[rgba(112,66,138,0.35)] disabled:opacity-50"
